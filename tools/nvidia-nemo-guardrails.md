...
> 5.6K stars; dialog/input/output/retrieval/execution rails; Colang DSL; sub-100ms GPU
...
> Raw results JSON: `benchmarks/security-guardrails-nvidia-nemo-guardrails-<date>.json`
