...
> Active WG; workload identity; SPIFFE successor; architecture + token formats; RFC expected 2027-2028
...
> Raw results JSON: `benchmarks/context-protocols-wimse-ietf-<date>.json`
