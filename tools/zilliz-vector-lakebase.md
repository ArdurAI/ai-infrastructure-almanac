...
- **Category**: Vector Databases & RAG Infrastructure
- **Type**: Managed (Milvus-based)
- **License**: Proprietary
- **Region**: N/A
- **Tier**: A
...
> 100B+ scale; lake-native; S3-based Vortex format; on-demand compute; Cardinal engine 10x
...
> Raw results JSON: `benchmarks/vector-databases-zilliz-vector-lakebase-<date>.json`
