...
> M365 ecosystem; embedded AI across Office; $30/user add-on; requires full M365
...
> Raw results JSON: `benchmarks/vector-databases-microsoft-copilot-m365-<date>.json`
