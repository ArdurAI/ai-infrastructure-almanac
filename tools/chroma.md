...
> ~16K stars; developer experience; pip install; Rust rewrite 4x faster; Context-1 agentic search
...
> Raw results JSON: `benchmarks/vector-databases-chroma-<date>.json`
