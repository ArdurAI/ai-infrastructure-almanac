...
> AWS-native; secret rotation; automated rotation via Lambda; KMS encryption; costly at scale
...
> Raw results JSON: `benchmarks/context-protocols-aws-secrets-manager-<date>.json`
