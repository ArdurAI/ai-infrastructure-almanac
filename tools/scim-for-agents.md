...
> Q1 2026; agent lifecycle mgmt; draft-abbey-scim-agent-extension; Agents + AgenticApplications resources
...
> Raw results JSON: `benchmarks/context-protocols-scim-for-agents-<date>.json`
