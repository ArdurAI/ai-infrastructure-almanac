...
- **Type**: Secrets Mgmt
- **License**: Open + Enterprise
- **Region**: N/A
- **Tier**: A
- **First Triaged**: 2026-06-16
- **Last Updated**: 2026-06-16

> Enterprise standard; secret rotation; dynamic secrets, multi-auth, transit encryption
...
> Raw results JSON: `benchmarks/context-protocols-hashicorp-vault-<date>.json`
