...
> 10M+ npm/week; OpenAI-native agents; Python/TypeScript; MCP support; handoffs, guardrails, tracing
...
> Raw results JSON: `benchmarks/context-protocols-openai-agents-sdk-<date>.json`
