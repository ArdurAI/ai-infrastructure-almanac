...
- **Type**: Search+Vector
- **License**: Elastic/AGPLv3
- **Region**: N/A
- **Tier**: A
- **First Triaged**: 2026-06-16
- **Last Updated**: 2026-06-16

> ~30K+ stars; enterprise search; GPU accel in v3.0; re-added AGPL 2024
...
> Raw results JSON: `benchmarks/vector-databases-elasticsearch-esre-<date>.json`
