...
> 150+ orgs in production; agent-to-agent coordination; Google → Linux Foundation; Agent Cards
...
> Raw results JSON: `benchmarks/context-protocols-a2a-agent-to-agent-<date>.json`
