...
- **Category**: Context Protocols, Authentication & Integration Standards
- **Type**: Protocol
- **License**: MIT (Open)
- **Region**: N/A
- **Tier**: A
...
> 97M monthly SDK downloads; agent-to-tool communication; Anthropic → AAIF/LF; JSON-RPC over stdio/HTTP
...
> Raw results JSON: `benchmarks/context-protocols-mcp-model-context-protocol-<date>.json`
...
- [A2A (Agent-to-Agent)](a2a-agent-to-agent.md)
- [UCP (Universal Commerce Protocol)](ucp-universal-commerce-protocol.md)
- [x402](x402.md)
- [WIMSE (IETF)](wimse-ietf.md)
- [AIMS (IETF)](aims-ietf.md)
